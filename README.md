...
> ⚠️ 非公式 MOD のため、ゲーム本体のアップデートで動作しなくなる場合があります。

## ドキュメント

インストール・機能・操作方法・設定・ビルド手順など、使い方はすべてドキュメントサイトにまとめています。

📖 **https://kidonaru.github.io/BG2VR/**

ダウンロードは [Releases](https://github.com/kidonaru/BG2VR/releases) から。
