...
public class SettingsController : MonoBehaviour
{
    ...
    /// <summary>パネル表示中か（VR モーダル入力アービトレーションのゲートに使う）。</summary>
    public bool IsShown => m_view != null && m_view.IsShown;

    /// <summary>VR 経路（SettingsPanelRunner）が Show/Hide/RT リダイレクト/ナビ handler を叩くための view 参照。</summary>
    internal SettingsView View => m_view;
    ...
    public void HandleCapturedKey(UnityEngine.InputSystem.Key k)
    {
        ...
        {
            foreach (var other in SettingsView.AllEntries())
            {
